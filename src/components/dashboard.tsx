                  ...
                  <div className="mb-2">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-4 px-4 sm:px-8 md:px-12 lg:px-16 snap-x snap-mandatory scrollbar-hide">
                      {[
                        ...
                        { name: 'TVS', icon: '/brands/tvs.png' },
                        { name: 'Bajaj', icon: '/brands/bajaj.png' },
                        { name: 'Hero', icon: '/brands/hero.png' },
                        { name: 'Vespa', icon: '/brands/vespa.png' },
                        { name: 'Chetak', icon: '/brands/chetak.png' },
                        { name: 'Ather', icon: '/brands/ather.png' },
                        { name: 'Ola', icon: '/brands/ola.png' },
                        { name: 'Simple Energy', icon: '/brands/simple.png' },
                        { name: 'Vida', icon: '/brands/vida.png' },
                        { name: 'Okinawa', icon: '/brands/okinawa.png' },
                        { name: 'Ampere', icon: '/brands/ampere.png' },
                        { name: 'Bounce', icon: '/brands/bounce.png' },
                        { name: 'Kinetic', icon: '/brands/kinetic.png' },
                        { name: 'Piaggio', icon: '/brands/piaggio.png' },
                        { name: 'Hero Electric', icon: '/brands/heroelectric.png' },
                        { name: 'LML', icon: '/brands/lml.png' },
                        { name: 'Joy e-bike', icon: '/brands/joy.png' },
                        { name: 'KTM', icon: '/brands/ktm.png' },
                        { name: 'Suzuki', icon: '/brands/suzuki.png' },
                        { name: 'Kawasaki', icon: '/brands/kawasaki.png' },
                        { name: 'Ducati', icon: '/brands/ducati.png' },
                        { name: 'BMW', icon: '/brands/bmw.png' },
                        { name: 'Triumph', icon: '/brands/triumph.png' },
                        { name: 'Harley Davidson', icon: '/brands/harley.png' },
                        { name: 'Jawa', icon: '/brands/jawa.png' },
                        { name: 'Yezdi', icon: '/brands/yezdi.png' },
                        { name: 'Revolt', icon: '/brands/revolt.png' },
                        { name: 'Husqvarna', icon: '/brands/husqvarna.png' },
                        { name: 'Aprilia', icon: '/brands/aprilia.png' },
                        { name: 'TATA', icon: '/brands/tata.png' },
                        { name: 'Mahindra', icon: '/brands/mahindra.png' },
                        { name: 'Maruti Suzuki', icon: '/brands/maruti.png' },
                        { name: 'Hyundai', icon: '/brands/hyundai.png' },
                        { name: 'Kia', icon: '/brands/kia.png' },
                        { name: 'Toyota', icon: '/brands/toyota.png' },
                        { name: 'MG', icon: '/brands/mg.png' },
                        { name: 'Renault', icon: '/brands/renault.png' },
                        { name: 'Nissan', icon: '/brands/nissan.png' },
                        { name: 'Skoda', icon: '/brands/skoda.png' },
                        { name: 'Volkswagen', icon: '/brands/volkswagen.png' },
                        { name: 'Jeep', icon: '/brands/jeep.png' },
                        { name: 'Ford', icon: '/brands/ford.png' },
                        { name: 'Mercedes-Benz', icon: '/brands/mercedes.png' },
                        { name: 'Audi', icon: '/brands/audi.png' },
                        { name: 'Volvo', icon: '/brands/volvo.png' },
                        { name: 'Land Rover', icon: '/brands/landrover.png' },
