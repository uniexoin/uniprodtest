...
function Landing() {
 ...
 <div className="container mx-auto px-6 md:px-12 lg:px-24 lg:px-8">
 ...
 style={{ y: heroY }}
 >
 <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-caption mb-6">
 <Zap className="w-3 h-3 fill-current" />
 <span>INDIA'S LARGEST MULTI-SERVICE HUB</span>
 </motion.div>

 <h1 className="text-4xl md:text-5xl lg:text-6xl font-display tracking-tight mb-6 text-foreground">
 ...
 className={`glass p-4 rounded-[2rem] flex flex-col items-center justify-center w-28 h-28 cursor-pointer transition-all duration-300 border border-border/40 dark:border-white/5 ${item.borderHover}`}
 >
 ...
 <span className="text-xs font-caption text-foreground/90 ">{item.label}</span>
 </motion.div>
 ))}
 </div>
 </motion.div>
 ...
 className="h-12 pl-12 text-base rounded-[2rem] border-2 focus-visible:ring-primary/20 bg-surface/50 backdrop-blur-sm placeholder:text-muted-foreground"
 />
 </div>
 <Button onClick={() => router.push('/signup')} size="lg" className="h-12 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-[2rem] shadow-premium-soft shadow-primary/20 transition-all hover:-translate-y-1 relative overflow-hidden group">
 ...
 <motion.div 
 style={{ y: badgeY1 }}
 className="glass absolute top-8 -left-4 lg:top-12 lg:-left-16 p-4 lg:p-5 rounded-[2rem] lg:rounded-3xl shadow-premium-deep flex flex-col gap-2 max-w-[180px] lg:max-w-[220px] animate-float z-30"
 >
 ...
 <motion.div 
 style={{ y: badgeY2 }}
 className="glass absolute bottom-12 -right-4 lg:bottom-20 lg:-right-20 p-4 lg:p-5 rounded-[2rem] lg:rounded-3xl shadow-premium-deep flex items-center gap-2 lg:gap-4 animate-float z-30"
 >
 ...
 <div className="relative p-2 rounded-3xl bg-surface backdrop-blur-md border border-white/10 group-hover:bg-surface transition-all">
 ...
 >
 <div className="glass-premium pulse-shadow-indigo rounded-[3rem] p-8 md:p-12 grid grid-cols-2 md:grid-cols-4 gap-12 border border-white/20 shadow-premium-deep bg-surface/50 backdrop-blur-2xl">
 ...
 <p className="text-sm font-caption text-muted-foreground mb-2">Properties</p>
 <h3 className="text-3xl md:text-4xl font-stat text-foreground"><Counter value={15000} />+</h3>
 </motion.div>
 ...
 <p className="text-sm font-caption text-muted-foreground mb-2">Vehicles</p>
 <h3 className="text-3xl md:text-4xl font-stat text-foreground"><Counter value={300} />K+</h3>
 </motion.div>
 ...
 <p className="text-sm font-caption text-muted-foreground mb-2">Reviews</p>
 <h3 className="text-3xl md:text-4xl font-stat text-foreground"><Counter value={45} />K+</h3>
 </motion.div>
 ...
 whileHover={{ rotate: -12, scale: 1.1 }}
 transition={{ type: "spring", stiffness: 400, damping: 10 }}
 className="w-16 h-16 rounded-3xl bg-cyan-50 dark:bg-cyan-950/200/10 flex items-center justify-center mb-6 shadow-inner group-hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all"
 >
 <Zap className="w-8 h-8 text-cyan-500" />
 </motion.div>
 <p className="text-sm font-caption text-muted-foreground mb-2">Active Users</p>
 <h3 className="text-3xl md:text-4xl font-stat text-foreground"><Counter value={250} />K+</h3>
 </motion.div>
 </div>
 </motion.div>
 </section>
 ...
 <section className="py-24 md:py-32 md:py-20 relative">
 <div className="container mx-auto px-6 md:px-12 lg:px-24 lg:px-8 max-w-7xl">
 <motion.div 
 whileInView="visible" viewport={{ once: true }} variants={fadeUp}
 className="text-center mb-12"
 >
 <h2 className="text-3xl md:text-5xl font-heading mb-6 text-foreground">
 Find your perfect match. <br />
 <span className="text-primary font-display italic">10X Faster than before.</span>
 </h2>
 ...
 <div className="w-12 h-12 rounded-[2rem] bg-primary/10 flex items-center justify-center text-primary font-bold text-xl group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
 {i + 1}
 </div>
 <div>
 ...
 <Button onClick={() => router.push('/signup')} className="bg-accent hover:bg-accent/90 text-white h-12 px-8 text-base rounded-[2rem] font-bold shadow-lg shadow-accent/20">
 ...
 <div className="border-[12px] border-slate-900 rounded-[3.5rem] bg-background shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] overflow-hidden aspect-[9/19] flex flex-col items-center relative">
 <div className="w-full h-14 bg-surface border-b flex items-center justify-center font-semibold text-primary">
 Book Item
 </div>
 <div className="p-6 w-full space-y-6 flex-1 mt-4">
 <div className="h-12 bg-surface rounded-[2rem] border px-4 flex items-center text-sm font-medium text-foreground/90 ">John Doe</div>
 <div className="h-12 bg-surface rounded-[2rem] border px-4 flex items-center text-sm font-medium text-foreground/90 ">+91 9876543210</div>
 <div className="p-5 bg-blue-50 dark:bg-blue-950/20/50 rounded-[2rem] border border-blue-100 dark:border-blue-900/30 space-y-3 relative">
 <span className="text-xs font-bold text-primary uppercase tracking-tighter">Selected Property</span>
 <div className="flex justify-between items-center bg-background p-3 rounded-3xl shadow-sm text-sm">
 <span className="font-bold">BMW 5 Series</span>
 <span className="text-accent font-black">Available</span>
 </div>
 </div>
 <div className="h-12 bg-surface rounded-[2rem] border px-4 flex items-center text-sm font-medium text-foreground/90 ">25/09/2026 9:00 AM</div>

 <div className="mt-auto pt-10 w-full space-y-3">
 <div className="h-12 w-full bg-surface rounded-[2rem] border px-4 flex items-center justify-center text-sm font-bold text-foreground/90 ">Enter Token Amount</div>
 <div className="h-12 w-full bg-primary rounded-[2rem] flex items-center justify-center text-sm font-bold text-white shadow-lg shadow-primary/30">Confirm Booking</div>
 </div>
 </div>
 </div>
 ...
 className="absolute -right-4 lg:-right-16 top-1/3 glass p-4 rounded-[2rem] shadow-premium-soft z-20"
 >
 ...
 <section className="py-24 md:py-32 md:py-20 relative bg-surface overflow-hidden">
 ...
 <h2 className="text-3xl md:text-5xl font-heading mb-6 text-foreground">
 100% Secure. <br />
 <span className="text-primary font-display italic">Zero friction operations.</span>
 </h2>
 <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
 ...
 className="group p-6 rounded-3xl border border-border glass hover:bg-surface/80 transition-all duration-300 shadow-premium-soft shadow-primary/5"
 >
 <div className="flex items-start gap-5">
 <div className="w-12 h-12 rounded-[2rem] bg-primary/10 flex items-center justify-center text-primary font-bold text-xl group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
 ...
 <Button onClick={() => router.push('/signup')} className="bg-primary hover:bg-primary/90 text-primary-foreground h-12 px-8 text-base rounded-[2rem] font-bold shadow-lg shadow-primary/20 relative overflow-hidden group">
 <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] skew-x-[-20deg]" />
 ...
 <div className="border-[12px] border-slate-800 rounded-[3.5rem] bg-background shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden aspect-[9/19] flex flex-col">
 <div className="w-full h-16 bg-surface border-b flex items-center px-6 font-bold text-foreground">
 Manage Bookings
 </div>
 ...
 className="bg-card p-4 rounded-[2rem] border shadow-sm flex items-center justify-between relative"
 >
 ...
 <p className={`text-sm font-black ${user.pending ? 'text-orange-500' : 'text-foreground'}`}>{user.price}</p>
 </div>
 ...
 className="absolute -right-10 lg:-right-24 top-1/2 -translate-y-1/2 glass p-4 rounded-[2rem] shadow-premium-deep w-40 lg:w-48 z-20"
 >
 <div className="flex items-center gap-2 mb-2 text-primary">
 <Zap className="w-4 h-4 fill-current" />
 <span className="text-[10px] font-black uppercase">Quick Remind</span>
 </div>
 <div className="h-2 bg-surface rounded-full w-full mb-1" />
 <div className="h-2 bg-surface rounded-full w-2/3" />
 </motion.div>
 )}
 </motion.div>
 ))}
 </div>
 <div className="p-5 bg-surface border-t">
 <Button className="w-full h-12 bg-primary rounded-3xl font-bold">
 Process Selection
 </Button>
 </div>
 </div>
 ...
 <section className="py-24 md:py-32 md:py-20 bg-background relative">
 <div className="container mx-auto px-6 md:px-12 lg:px-24 lg:px-8 max-w-7xl">
 <motion.div 
 whileInView="visible" viewport={{ once: true }} variants={fadeUp}
 className="text-center mb-12"
 ...
 <span className="text-primary font-display italic">Live in seconds.</span>
 </h2>
 ...
 {/* Premium Tabs */}
 <div className="flex justify-center gap-3 flex-wrap p-2 glass max-w-fit mx-auto rounded-[2rem] border-border shadow-premium-soft bg-surface/30 relative">
 {[
 ...
 className="absolute inset-0 bg-primary rounded-[1.5rem] shadow-premium-soft shadow-primary/30 -z-10"
 ...
 className="border-[12px] border-slate-900 rounded-[3.5rem] bg-background shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] hover:shadow-[0_60px_120px_-20px_rgba(99,102,241,0.25)] overflow-hidden aspect-[9/19] flex flex-col pt-10 relative group transition-all duration-500"
 >
 ...
 <h3 className="font-black text-2xl text-foreground">Premium Suite</h3>
 <ShieldCheck className="w-5 h-5 text-accent" />
 </div>
 <p className="text-sm text-muted-foreground mb-6">City Center • Fully Furnished</p>

 <div className="p-4 rounded-[2rem] bg-blue-50 dark:bg-blue-950/20/50 border border-blue-100 dark:border-blue-900/30 mb-6">
 <div className="flex items-baseline gap-2">
 <span className="text-2xl font-data font-bold text-primary">₹15,000</span>
 <span className="text-xs font-caption text-muted-foreground">/ Month</span>
 </div>
 </div>

 <div className="grid grid-cols-2 gap-4 mb-8">
 {['Wi-Fi', 'Parking', 'Security', 'AC'].map(a => (
 <div key={a} className="flex items-center gap-2 text-xs font-bold text-foreground/90 ">
 <CheckCircle2 className="w-4 h-4 text-accent" /> {a}
 </div>
 ))}
 </div>

 <Button className="w-full h-14 bg-primary text-white rounded-[2rem] font-bold shadow-lg shadow-primary/20">
 Check Availability
 </Button>
 </div>
 </motion.div>
 ...
 <div className="px-8">
 <div className="flex items-center justify-between mb-2">
 <h3 className="font-black text-2xl text-foreground">BMW 5 Series</h3>
 <Zap className="w-5 h-5 text-orange-500" />
 </div>
 <p className="text-sm text-muted-foreground mb-6">Automatic • Diesel • Luxury</p>

 <div className="p-4 rounded-[2rem] bg-orange-50 dark:bg-orange-950/20 border border-orange-100 dark:border-orange-900/30 mb-6">
 <div className="flex items-baseline gap-2">
 <span className="text-2xl font-data font-bold text-orange-600">₹3,500</span>
 <span className="text-xs font-caption text-orange-400">/ Day</span>
 </div>
 </div>
 ...
 <Button className="w-full h-14 bg-orange-50 dark:bg-orange-950/200 text-white rounded-[2rem] font-bold shadow-lg shadow-orange-500/20">
 Book Instant
 </Button>
 </div>
 </motion.div>
 ...
 >
 <div className="px-6 mb-6">
 <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-lg bg-background flex items-center justify-center">
 ...
 <div className="px-8">
 <div className="flex items-center justify-between mb-2">
 <h3 className="font-black text-2xl text-foreground">Dell XPS 13</h3>
 <span className="px-3 py-1 bg-surface text-foreground/90 text-[10px] font-black rounded-full">LIKE NEW</span>
 </div>
 <p className="text-sm text-muted-foreground mb-6">16GB RAM • 512GB SSD</p>

 <div className="p-4 rounded-[2rem] bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 mb-6">
 <div className="flex items-baseline gap-2">
 <span className="text-2xl font-data font-bold text-emerald-700">₹45,000</span>
 <span className="text-xs font-data text-emerald-400 line-through">₹85K</span>
 </div>
 </div>
 ...
 <Button variant="outline" className="flex-1 h-14 rounded-[2rem] font-bold border-2">Offer</Button>
 <Button className="flex-1 h-14 bg-emerald-600 rounded-[2rem] font-bold shadow-lg shadow-emerald-600/20">Buy Now</Button>
 </div>
 </div>
 </motion.div>
 )}
 ...
 <div className="px-8">
 <h3 className="font-black text-2xl text-foreground mb-2">Premium Wash</h3>
 <p className="text-sm text-muted-foreground mb-6">Pick-up & Drop included</p>

 <div className="space-y-3 mb-8">
 {['Shirts', 'Pants'].map((item, idx) => (
 <div key={item} className="flex justify-between items-center bg-surface p-4 border rounded-[2rem] shadow-sm">
 <span className="text-sm font-bold">{item}</span>
 <div className="flex items-center gap-4">
 <button className="w-8 h-8 rounded-3xl bg-surface flex items-center justify-center font-bold">-</button>
 <span className="text-sm font-black">{idx === 0 ? '5' : '2'}</span>
 <button className="w-8 h-8 rounded-3xl bg-blue-100 text-blue-600 flex items-center justify-center font-bold">+</button>
 </div>
 </div>
 ))}
 </div>
 ...
 <span className="text-2xl font-data font-bold text-blue-600">₹350</span>
 </div>

 <Button className="w-full h-14 bg-blue-600 text-white rounded-[2rem] font-bold shadow-lg shadow-blue-600/20">
 Schedule Pick-up
 </Button>
 </div>
 </motion.div>
 ...
 >
 <div className="glass-premium pulse-shadow-indigo p-3 rounded-[2rem] shadow-premium-deep flex flex-col items-center gap-1 cursor-pointer hover:scale-110 transition-transform">
 <div className="w-8 h-8 rounded-3xl bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold">₹</div>
 <span className="text-[8px] font-caption text-foreground/90 ">Payment</span>
 </div>
 <div className="glass-premium pulse-shadow-indigo p-3 rounded-[2rem] shadow-premium-deep flex flex-col items-center gap-1 cursor-pointer hover:scale-110 transition-transform">
 <div className="w-8 h-8 rounded-3xl bg-blue-100 flex items-center justify-center text-indigo-600 font-bold">W</div>
 <span className="text-[8px] font-caption text-foreground/90 ">Web Link</span>
 </div>
 </motion.div>
 ...
 >
 <div className="glass-premium pulse-shadow-rose p-3 rounded-[2rem] shadow-premium-deep flex flex-col items-center gap-1 cursor-pointer hover:scale-110 transition-transform">
 <div className="w-8 h-8 rounded-3xl bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center text-pink-600 font-bold">★</div>
 <span className="text-[8px] font-caption text-foreground/90 ">Reviews</span>
 </div>
 </motion.div>
 </div>
 ...
 className="flex items-start gap-4 p-6 rounded-[2rem] border border-slate-100 hover:border-primary/20 hover:bg-background /50 transition-all group"
 >
 ...
 <p className="text-xl font-bold text-foreground leading-snug">{feat}</p>
 </motion.div>
 ))}
 </div>

 <div className="pt-4">
 <Button className="bg-primary hover:bg-secondary text-white h-16 px-12 text-xl rounded-[2rem] font-bold shadow-premium-deep transition-all hover:-translate-y-1">
 ...
 className="absolute bottom-6 left-6 right-6 p-4 rounded-3xl bg-surface backdrop-blur-md border border-white/20 flex items-center gap-4 transition-transform duration-500 group-hover:-translate-y-2 shadow-premium-soft"
 >
 <Avatar className="w-14 h-14 border-2 border-white shadow-premium-soft">
 ...
 whileTap={{ scale: 0.9 }}
 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-surface backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center shadow-premium-deep text-white z-10 transition-all duration-500 hover:bg-surface hover:text-primary group-hover:scale-110"
 >
 ...
 <div className="flex flex-col">
 <span className="text-foreground font-stat text-lg">25+ Months</span>
 <span className="text-xs font-caption text-muted-foreground">Active Partner</span>
 </div>
 <div className="w-px h-10 bg-border" />
 <div className="flex flex-col">
 <span className="text-foreground font-stat text-lg">500+ Deals</span>
 <span className="text-xs font-caption text-muted-foreground">Completed</span>
 </div>
 </motion.div>
 </motion.div>
 </div>
 ...
 <span className="text-accent text-xs font-caption tracking-[0.2em]">Join 250,000+ Users</span>
 </motion.div>

 {/* Headline — refined typography */}
 <h2 className="mb-6 leading-[0.95] tracking-tight">
 <span className="block text-5xl md:text-7xl lg:text-8xl font-heading text-white/90 uppercase">
 Ready to
 </span>
 <span className="block text-6xl md:text-8xl lg:text-9xl font-display uppercase" style={{ WebkitTextStroke: '2px #C9A84C', color: 'transparent' }}>
 Get Started?
 </span>
 </h2>
 ...
 <Button size="lg" className="h-16 px-12 bg-accent hover:bg-accent/90 text-primary text-lg font-black rounded-[2rem] shadow-premium-deep shadow-accent/30 relative overflow-hidden group">
 <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
 <span className="relative z-10">Join Now — It's Free</span>
 </Button>
 </motion.div>
 <motion.div whileHover={{ scale: 1.04, y: -4 }} whileTap={{ scale: 0.97 }}>
 <Button size="lg" variant="outline" className="h-16 px-12 bg-transparent border-2 border-white/20 hover:border-accent/50 text-white/80 hover:text-white hover:bg-surface /5 text-lg font-black rounded-[2rem] transition-all">
 Contact Sales
 </Button>
 </motion.div>
 </div>
 ...
 {/* Trust badges */}
 <div className="mt-12 flex flex-wrap justify-center gap-6 text-white/30 text-xs font-caption">
